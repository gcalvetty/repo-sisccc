...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="header">Menú de Super Administrador</li>
            <li class="<?php echo ((Route::current()->getName() == 'AdmCCC.Reg'))? "active":"";?>">
                <a href="{{ route('AdmCCC.Reg') }}">
            ...
            <hr>
            <li class="<?php echo ((Route::current()->getName() == 'AdmCCC.cuadSegui'))? "active":"";?>">
                <a href="{{ route('AdmCCC.cuadSegui') }}">
