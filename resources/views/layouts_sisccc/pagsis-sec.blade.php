...
<html lang="es"><head>
        ...
        <link href="/css/ccc-gecn.css" rel="stylesheet">

        @if(Route::current()->getName() == 'rude-s.edit')
            @include('layouts_secretaria.partials.pagsis_css')
        @endif
    ...
    <body class="sidebar-collapse hold-transition skin-blue sidebar-mini"> 
        ...
        @if(Route::current()->getName() == 'rude-s.edit')
            @include('layouts_secretaria.partials.pagsis_js')
        @endif               
