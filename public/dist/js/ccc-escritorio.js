...
(function ($, ccc) {
  ...
  demo_settings.append(
      ...
      + "Fixed layout"
      + "</label>"
      + "<p>Active el Menú fijo. No se pueden usar Menú fijos y en caja juntos</p>"
      + "</div>"
        //Boxed layout
      + "<div class='form-group'>"
      + "<label class='control-sidebar-subheading'>"
      + "<input type='checkbox' data-layout='layout-boxed'class='pull-right'/> "
      + "Caja de Configuracion"
      + "</label>"
      ...
      + "Barra lateral Expandir en Hover"
      + "</label>"
      ...
      + "</label>"
      + "<p>Alternar entre fondo oscuras y claras para la barra lateral derecha</p>"
      + "</div>"
	  */
  );
