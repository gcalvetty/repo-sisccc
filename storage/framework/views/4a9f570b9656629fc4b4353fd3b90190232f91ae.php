        ...
        <div class="panel panel-success row">
            ...
            <div class="panel-body"> 
                <div class="col-md-6">
                    ...
                    <a href="<?php echo e(route('inscr-ccc-nuevo')); ?>" target="_blank">
                ...
                <div class="col-md-6">            
                    <a href="<?php echo e(route('inscr-ccc-ant')); ?>" target="_blank" >
        ...
        <div class="panel panel-info row">
            ...
            <div class="panel-body"> 
                <div class="list-group">
                    <a href="<?php echo e(route('rep.alumnos', ['nivel' => 4])); ?>" class="list-group-item">
                        <i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i> <b>Taller Inicial</b>
                    </a>
                    <a href="<?php echo e(route('rep.alumnos', ['nivel' => 1])); ?>" class="list-group-item">                        
                        <i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i> <b>Inicial / Sección</b>
                    </a>
                    <a href="<?php echo e(route('rep.alumnos', ['nivel' => 2])); ?>" class="list-group-item">
                        <i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i> <b>Primaria</b>
                    </a>
                    <a href="<?php echo e(route('rep.alumnos', ['nivel' => 3])); ?>" class="list-group-item">
