...
<html lang="es"><head>
        ...
        <link href="<?php echo e(elixir('/css/sisccc-contador.css')); ?>" rel="stylesheet"> 
    ...
    <body class="sidebar-mini skin-green wysihtml5-supported"> 
        ...
        <div class="wrapper">
            <?php if(Auth::guest()): ?>       		
            <?php else: ?>     
            <?php echo Html::menuccc(); ?> <!-- creamos el sub-menu -->
            <?php endif; ?>
        ...
        <script src="<?php echo e(asset("js/app-tabla.js")); ?>" ></script> 
