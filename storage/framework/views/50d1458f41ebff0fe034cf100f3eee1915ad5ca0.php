            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php if(Auth::guest()): ?>
                        <li><a href="<?php echo e(url('/login')); ?>"><i class="fa fa-sign-in" aria-hidden="true"></i> <?php echo app('translator')->getFromJson('auth.login'); ?></a></li>
                        
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('usu_adm')): ?>
                        <li><a href="<?php echo e(url('/register')); ?>"><i class="fa fa-user-plus" aria-hidden="true"></i> <?php echo app('translator')->getFromJson('auth.register'); ?>-111</a></li>
                        <?php endif; ?>
                        <?php else: ?>
                        <li class="dropdown">
