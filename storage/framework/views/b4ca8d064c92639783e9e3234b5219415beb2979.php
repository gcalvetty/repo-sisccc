...
<?php echo $__env->make('layouts_regente.partials.menu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" >
                        ...
                        <ul class="list-group col-lg-12">
                            <li class="list-group-item list-group-item-success col-lg-6">
                                <div class="radio">
                                    <label>
                            ...
                            <li class="list-group-item list-group-item-info col-lg-6">
                                <div class="radio">
                                    <label>
                            ...
                            <li class="list-group-item list-group-item-warning col-lg-6">
                                <div class="radio">
                                    <label>
                            ...
                            <li class="list-group-item list-group-item-danger col-lg-6">
                                <div class="radio">
                                    <label>
...
<?php echo $__env->make('layouts_sisccc.pagsis_regente', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>