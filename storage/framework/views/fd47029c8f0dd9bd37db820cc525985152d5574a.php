        ...
        <div class="row ">
            <div  class="container inscripcion inscrForm col-md-12">
                <div class="panel panel-success">
                    <div class="panel-heading">Libreta [<?php echo $__env->yieldContent('titulo'); ?>]</div> 
                    <div class="panel-body">
                        ...
                        <div id="app" class="container-fluid"> 
                            <form v-on:submit="validateBeforeSubmit" class="form-horizontal" role="form" method="PUT" action="<?php echo e(route('libreta-d.update', ['alumno' => $Alumno->user_id])); ?>">
                                <?php echo e(csrf_field()); ?>

                                <?php echo $__env->make('layouts_sisccc.partials.pagsis_edit_libreta', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>                   
                            </form>
                        </div>    
                    </div>
                </div>
