                        ...
                        <div class="box-body">
                            <form action="#" v-on:submit.prevent="crearEvento" method="post">
                                ...
                                <div class="form-group has-feedback" v-bind:class="{'': true, 'has-error': errors.has('fec_fin') }">
                                    <div class="input-group">
                                        <span class="input-group-addon" id="basic-addon10"><i class="fa fa-calendar-o" aria-hidden="true"></i></span>
                                        <input type="text" class="form-control" id="fec_nac"  name="fec_fin" value="<?php echo e(old('fec_fin')); ?>"  placeholder="Fecha Final DD/MM/YYYY" aria-describedby="basic-addon10" v-model="fec_nac"  v-validate.initial="fec_nac" data-vv-rules="required|date_format:DD/MM/YYYY" data-vv-delay="200" v-bind:class="{'': true, 'has-error': errors.has('fec_nac') }">
                                    </div>
                                ...
                                <div class="form-group has-feedback" v-bind:class="{'': true, 'has-error': errors.has('evento') }">
                                    <div class="input-group">
                                        <span class="input-group-addon" id="basic-addon10"><i class="fa fa-calendar-o" aria-hidden="true"></i></span>
                                        <input type="text" class="form-control" id="fec_nac"  name="evento" value="<?php echo e(old('evento')); ?>"  placeholder="Evento" aria-describedby="basic-addon10" v-model="evento"  v-validate.initial="evento" data-vv-rules="required" data-vv-delay="200" v-bind:class="{'': true, 'has-error': errors.has('evento') }">
                                    </div>
                                    <span class="glyphicon  form-control-feedback" aria-hidden="true" v-bind:class="{'': true, 'glyphicon-remove': errors.has('fec_fin') }"></span>                                    
                                </div>
