...
<div  class="container inscrForm">
    ...
    <div class="panel panel-success">
       <div class="panel-heading"><i class="fa fa-file-text fa-2x" aria-hidden="true"></i> Formulario</div>
        <div class="panel-body">
            <div id="app" class="container-fluid"> 
                <form v-on:submit="validateBeforeSubmit" class="form-horizontal" role="form" method="POST" action="<?php echo e(route('inscr-reg')); ?>">
