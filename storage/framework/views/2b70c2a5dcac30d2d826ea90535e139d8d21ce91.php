...
<html lang="es"><head>
    ...
    <body class="sidebar-mini skin-green wysihtml5-supported"> 
        ...
        (Route::current()->getName() == 'rude-ins.edit')or
        (Route::current()->getName() == 'rude-s.edit')): ?>
        <?php echo $__env->make('layouts_sisccc.partials.pagsis_edit_js', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>               
        <?php if((Route::current()->getName() == 'Admtr.Reg')): ?>             
        <?php echo $__env->make('layouts_sisccc.partials.pagsis_charts_js',['some' => 'data'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>            
        <?php endif; ?>
    </body>