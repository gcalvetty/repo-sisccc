...
<div class="content-wrapper">    	
            ...
            <section class="col-lg-4 connectedSortable ui-sortable">
                <div class="box box-primary">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $l1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Prof1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($Prof1->id); ?></td>                                      
                                <td><?php echo e($Prof1->nombre); ?>, <?php echo e($Prof1->ape_paterno); ?> <?php echo e($Prof1->ape_materno); ?>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary" 
                                            ...
                                            data-iddoc="<?php echo e($Prof1->id); ?>"
                                            data-nomdoc="<?php echo e($Prof1->ape_paterno); ?> <?php echo e($Prof1->ape_materno); ?> <?php echo e($Prof1->nombre); ?>"
                                            >
            ...
            <section class="col-lg-4 connectedSortable ui-sortable">
                <div class="box box-success">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $l2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Prof1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($Prof1->id); ?></td>                                      
                                <td><?php echo e($Prof1->nombre); ?>, <?php echo e($Prof1->ape_paterno); ?> <?php echo e($Prof1->ape_materno); ?>
            ...
            <section class="col-lg-4 connectedSortable ui-sortable ">
                <div class="box box-info">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $l3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Prof1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($Prof1->id); ?></td>                                      
                                <td> <?php echo e($Prof1->nombre); ?>, <?php echo e($Prof1->ape_paterno); ?> <?php echo e($Prof1->ape_materno); ?>
            ...
            <section class="col-lg-6 connectedSortable ui-sortable">
                <div class="box box-title">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $l4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Prof1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($Prof1->id); ?></td>                                      
                                <td><?php echo e($Prof1->nombre); ?>, <?php echo e($Prof1->ape_paterno); ?> <?php echo e($Prof1->ape_materno); ?>
            ...
            <section class="col-lg-6 connectedSortable ui-sortable">
                <div class="box box-danger">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $l0; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Prof1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($Prof1->id); ?></td>                                      
                                <td><?php echo e($Prof1->nombre); ?>, <?php echo e($Prof1->ape_paterno); ?> <?php echo e($Prof1->ape_materno); ?></b>
                                </td>
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="DocenteModal">
        <div class="modal-dialog" role="document">
            <form action="<?php echo e(route('Dir.asig.materias')); ?>" id="matDoc">                
...
<?php echo $__env->make('layouts_sisccc.pagsis_docentes', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>