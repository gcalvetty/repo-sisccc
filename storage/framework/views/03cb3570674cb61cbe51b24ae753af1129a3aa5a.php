...
<?php $__env->startSection('titulo','Inscripción'); ?>
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="app" class="container-fluid"> 
                            <form v-on:submit="validateBeforeSubmit" class="form-horizontal" role="form" method="PUT" action="<?php echo e(route('rude-ins.update', ['alumno' => $Alumno->user_id])); ?>">
